...
class Command {
    /**
     * @param {number | OpCode} opcode The OpCode of the command
     * @param  {...any} args An array of parameters fitting to the OpCode
     */
    ...
    /**
     * Get the value at the corresponding index in the command model
     * @param {number} index
     */
    GetAt(index) {
    ...
    /**
     * Set a value at the corresponding index in the command model
     * @param {number} index
     * @param {any} data
     */
    SetAt(index, data) {
    ...
    /**
     * @returns {Buffer} Buffered representation of the command
     */
    get Buffer() {
